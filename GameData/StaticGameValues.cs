...
public static class StaticGameValues
{
    ...
    // Theme colours
    public static Color lightText = new Color(0.8509f, 0.8666f, 0.8980f, 1);
    public static Color darkText = new Color(0.3921f, 0.2509f, 0.1294f, 1);
    public static Color narrationText = new Color(0.094f, 0.49f, 0.455f, 0.7f);
